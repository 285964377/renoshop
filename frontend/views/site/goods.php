...
<?php require "heard.php"?>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			...
			<h2>当前位置：<a href="">首页</a> > <a href="">电脑、办公</a> > <a href="">笔记本</a> > <?=$g->name?></h2>
		     <?php endforeach; ?>
        </div>
		<!-- 面包屑导航 end -->
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
                <?php foreach ($goods as $g):?>
				<h3><strong><?=$g->name?></strong></h3>
				<?php endforeach;?>
				<!-- 图片预览区域 start -->
				<div class="preview fl">
					<div class="midpic">

<!--                       images/preview_l1.jpg-->
						<a href="<?=$pt->path?>" class="jqzoom" rel="gal1">      <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
						      <img src="<?=$pt->path?>" alt=""width="360px" height="300px"/>       <!-- 第一幅图片的中图 -->
					</a>
...
<!--                            <div class="midpic">-->
                            <ul>
                                <?php foreach ($photh as $k=>$p):?>
								<li <?=$k?' class="cur"':''?> >

									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$p->path?>',largeimage: '<?=$p->path?>'}"><img src="<?=$p->path?>"></a>
								</li>
                                <?php endforeach;?>
<!--								<li>-->
...
<!--								</li>-->
				...
				<div class="goodsinfo fl ml10">
                    <?php  foreach ($goods as $g): ?>
					<ul>
                        <li class="sn"><span>商品编号: </span><em><?=$g->sn?></em></li>
						<li class="market_price"><span>商品定价：</span><em><?=$g->market_price?></em></li>
						<li class="shop_price"><span>本店售价：</span> <strong><?=$g->shop_price?></strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span><?=date('Y年-m月-d日 H时',$g->create_time) ?></li>
						<li><span>浏览次数</span><em><?=$g->view_times?></em></li>

						<li class="star"><span>商品评分：</span> <strong></strong><a href=""></a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
                    <?php  endforeach;?>
							...
							<li>
								<dl>
									...
									<dd>
                                        ...
                                        <input type="hidden" name="goods_id" value="<?=$gds->id?>">
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
                                <?php  foreach ($goods as $go):?>
								<li><span><?=$go->name?></span></li>
								<li><span><?=$go->sn?></span></li>
								<li><span><?=$go->brand_id?></span>联想（Thinkpad）</li>
								<li><span><?=date('Y-m-d',$go->create_time)?></span></li>
